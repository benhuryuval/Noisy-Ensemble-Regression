...
sigma_profile_type = "noiseless_fraction"  # "noiseless_fraction" / "uniform"
T = 16
...
for data_type_idx, data_type in enumerate(data_type_vec):
    fname = data_type + "_" + reg_algo.lower() + "_" + bagging_method + "_" + str(T) + "_" + criterion + "_" + sigma_profile_type + ".csv"
